...
<?php
	...
	echo "<b>Please go back, and write something in the search box!</b>";
	exit();
	}

	$result_query = "select * from site where site_keywords like '%$get_value%'";

	$run_result = mysqli_query($result_query);

	if(mysqli_num_rows($run_result)<1){

	echo "<b>Oops! sorry, nothing was found in the database!</b>";
	exit();
